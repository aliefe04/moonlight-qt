...
#define SER_MIC_PASSTHROUGH "micpassthrough"
...
void StreamingPreferences::reload()
{
    ...
    micPassthrough = settings.value(SER_MIC_PASSTHROUGH, false).toBool();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_MIC_PASSTHROUGH, micPassthrough);
}
